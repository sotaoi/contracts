 ...
 * ```
 */
declare namespace NotificationInterface {
  /**
   ...
   */
  function mixin(options: SweetAlertOptions): typeof NotificationInterface;
...
export interface SweetAlertResult<T = any> {
  ...
  readonly value?: T;
  readonly dismiss?: NotificationInterface.DismissReason;
}
